...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="download_link">{{ trans('cruds.post.fields.download_link') }}</label>
                <input class="form-control {{ $errors->has('download_link') ? 'is-invalid' : '' }}" type="text" name="download_link" id="download_link" value="{{ old('download_link', $post->download_link) }}">
                @if($errors->has('download_link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('download_link') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.post.fields.download_link_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="preview_link">{{ trans('cruds.post.fields.preview_link') }}</label>
                <input class="form-control {{ $errors->has('preview_link') ? 'is-invalid' : '' }}" type="text" name="preview_link" id="preview_link" value="{{ old('preview_link', $post->preview_link) }}">
                @if($errors->has('preview_link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('preview_link') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.post.fields.preview_link_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.post.fields.cover_helper') }}</span>
            </div>
            <div class="form-group">
